...
(function () {
    'use strict';
    angular.module('fundoo.services', []).factory('createDialog', function ($document, $compile, $rootScope, $controller, $timeout, $templateCache) {
